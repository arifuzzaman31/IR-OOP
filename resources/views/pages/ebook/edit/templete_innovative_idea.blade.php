...
@section('content')
<div class="section m-4 ebook_edit_form">
    <div class="widget widget-table-two">
        <div class="widget-heading">
            <h5>{{ $page_title }} <br>
            </h5>
            <p>Category - {{ $ebook->templates_mave->title }}</p>
        ...
        <div class="widget-body">
            <form id="cf-form" action="{{url('/admin/ebook_store/')}}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        @include('partials.upload_files', ['label' => "Cover Picture" , 'name' =>"profile_picture_id", 'value'=>$ebook->cover_image_id, 'multiple' => false, 'preview_url' => ($ebook->cover_image_mave && $ebook->cover_image_mave->file_path) ])
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 mb-2">
                        <label for="ebook_abstract">Abstract</label>
                        <textarea class="form-control dynamic_data" name="ebook_abstract" id="ebook_abstract" cols="30" rows="10"></textarea>
                    </div>
                    <div class="col-md-12 mb-2">
                        <label for="ebook_intro">Introduction and Objective</label>
                        <textarea class="form-control dynamic_data" name="ebook_intro" id="ebook_intro" cols="30" rows="10"></textarea>
                    </div>
                    <div class="col-md-12 mb-2">
                        <label for="ebook_literature_review">Literature Review</label>
                        <textarea class="form-control dynamic_data" name="ebook_literature_review" id="ebook_literature_review" cols="30" rows="10"></textarea>
                    </div>
                    <div class="col-md-12 mb-2">
