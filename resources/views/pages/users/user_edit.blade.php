        ...
        <div class="widget-body">
            <form action="{{ url('admin/user/update/'.$user->id)}}" method="POST" id="cf-form">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        @include('partials.upload_files', ['label' => "Profile Picture" , 'name' =>"profile_picture_id", 'value'=> $user->profile_picture_id , 'preview_url' => ($user->profile_pic_mave && $user->profile_pic_mave->file_path) , 'multiple' => false])
                    </div>
                </div>
            </form>
        </div>
