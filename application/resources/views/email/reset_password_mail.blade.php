                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="padding-top: 30px;">
                                        ...
                                        <p> <a class="align-center" href="{{ $details['backUri'] }}/resetPassword?token={{ $details['token'] }}&email={{ $details['email'] }}" target="_blank" style="font-size: 15px; letter-spacing: .5px;  background-color:#1f988e; color: #fff; padding: 12px 25px; text-decoration: none; border-radius: 4px"> Reset Password </a> </p>
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr align="center">
                            <td class="content-block">
                                <span class="apple-link">You Can Always reach us at <a href="https://ebook.actionaid.com" style="color: #0198E1;"> {{ url('/') }} </a> </span>
                                <br> Don't like these emails? <a href="#">Unsubscribe</a>.
                            </td>
                        </tr>
                        <tr>
                            <td class="content-block powered-by">
                                Powered by <a target="_blank" href="{{url('/')}}" target="_blank">Ebook - Action Aid</a>.
                            </td>
                        </tr>
                    </table>
                </div>
