        ...
        <div class="widget-body">
            <form id="cf-form" action="{{url('/admin/ebook_store/')}}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        @include('partials.upload_files', ['label' => "Cover Picture" , 'name' =>"profile_picture_id", 'value'=>$ebook->cover_image_id, 'multiple' => false, 'preview_url' => $ebook->cover_image_mave?->file_path ])
                    </div>
                </div>
                <div class="row">
