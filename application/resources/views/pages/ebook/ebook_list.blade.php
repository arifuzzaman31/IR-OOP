                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                (Auth::user()->role_id == 1 || Auth::user()->role_id == 2 ||(Auth::user()->role_id == 3 && (CustomHelper::jury_circular_evaluation_auth($item['circular_id'],Auth::user()->id) > 0 ))))
                                @if(CustomHelper::jury_evaluated_check($item['id'],Auth::user()->id) == true)
